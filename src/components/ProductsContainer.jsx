...
const ProductsContainer = () => {
    ...
    const productsContent = layout === 'grid' ? <ProductsGrid /> : <ProductsList />;
    ...
    return (
        <>
            ...
            {/* PRODUCTS */}
            <div>{totalProducts === 0 ? <h5 className='text-2xl mt-16'>Sorry, no products matched your search...</h5> : productsContent}</div>
        </>
    );
};
